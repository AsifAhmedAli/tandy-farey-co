...
<main>
  ...
  <div class="content">
    <div class="d-flex align-items-center justify-content-between flex-wrap">
      <h1 class="mainUserText">Active Agents</h1>
      <div class="row g-3">
    ...
    <div class="table-responsive">
      <table class="table align-middle">
        ...
        <tbody class="fs-14">
          ...
          $sql = "SELECT * FROM users where role1='agent' and status = 'active'";
            ...
            <!-- <div class="spinner-border"  ></div> -->
              <div class="dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  ...
                  <li>
                    <button onclick="disableagent('<?php echo $idofagent; ?>')" class="dropdown-item">
                      Delete
                    </button>
                  </li>
                </ul>
