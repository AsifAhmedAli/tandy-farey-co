...
?>
    <div class="content" id="canbereplaced">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap">
            ...
            <form id="editproperty" class="col-12">
            ...
            <form id="changestatus" class="col-12">
                <h3>Status</h3>
                                    <select name="status" class="border py-0 form-select">
                                        <?php
                                        switch ($editpropertystatus) {
                                            case 'Available':
                                                ?>
                                                ...
                                                case 'Sold':
                                                    ...
                                                    case 'Held':
                                                        ...
                                                        <option value="Available">Available</option>
                                                        <option value="Sold">Sold</option>
                                                        <option selected value="Held">Held</option>
                                                        <option value="Contracted">Contracted</option>
                                                        <option value="Settled">Settled</option>
                                                        <option value="Reserved">Reserved</option>
                                                                                    <?php
                                                        ...
                                                        case 'Contracted':
                                                            ...
                                                            <option value="Sold">Sold</option>
                                                            <option value="Held">Held</option>
                                                            <option selected value="Contracted">Contracted</option>
                                                            <option value="Settled">Settled</option>
                                                            <option value="Reserved">Reserved</option>
                                                                                        <?php
...
<?php
                                ...
                                <input style="visibility:hidden;" name="property_idqw" value="<?php echo $idofproperty; ?>">
                                <input style="visibility:hidden;" name="project_idqw" value="<?php echo $id; ?>">                                
                                <div class="col-12 text-end"><button class="btn btn-primary btn-lg px-5 py-2" type="submit">Update</button></div>
            <hr>
            </form>
            <?php
...
$("#floorplansuploadformforproperty").submit(function (event) {
    ...
    $.ajax({
        ...
        //     var myModal = new bootstrap.Modal(document.getElementById('exampleModaldfds'));
        //     myModal.show();
        // }
    </script>
