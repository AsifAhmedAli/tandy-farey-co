...
?>
          <tr>
            <td>
              <img src="<?php echo $address; ?>" width="52" height="52" class="d-inline-block me-3"
                alt="Image" />

                <?php 
                        if($thumbnail == 'yes'){
                          ?>
               <a href="<?php echo $address; ?>" target="_blank"> <?php echo $row['document_name']." <b>(Thumbnail)</b>"; ?></a>                          <?php
                        }else{
?>
                  ...
                  <li>
                    <a class="dropdown-item">
                      <div class="form-check ps-0 pe-4">
                        ...
                        if($thumbnail == 'yes'){
                          ?>
                        <input disabled checked onchange="changethumbnail('<?php echo $idofimage; ?>')" class="form-check-input float-end ms-auto" style="margin-right: -1.5rem" type="checkbox"
    ...
    <div class="modal-content">
      <div class="modal-body">
 	      <form id="fileuploadform">
              ...
              <input type="text" style="visibility: hidden;" id="imagesuploadform" name="imagesuploadform" value="<?php echo $id; ?>">
