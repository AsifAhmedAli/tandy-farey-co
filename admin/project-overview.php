  ...
  ?>
    ...
    <div class="row align-items-stretch g-3">
      ...
      <div class="col-md-2">
        <div class="row g-3">
          <div class="col-12">
            <div class="rounded border border-1 px-4 py-5" style="background-color: white">
              <h2 class="fs-1"><?php echo $total ?></h2>
              <p class="mb-0 fs-18">Total Apartments</p>
            </div>
          </div>
          <div class="col-12">
            <div class="rounded border border-1 px-4 py-5" style="background-color: #FAFC9A">
              <h2 class="fs-1"><?php echo $available ?></h2>
              <p class="mb-0 fs-18">Available Apartments</p>
            </div>
          </div>
          <div class="col-12">
            <div class="rounded border border-1 px-4 py-5" style="background-color: #a4bedb">
