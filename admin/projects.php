...
<main id="projectsmain">
  ...
  <div class="content">
    <div class="d-flex align-items-end justify-content-between flex-wrap mb-3">
      <div>
        <h1 class="mainUserText">All Projects</h1>
        ...
        <div class="my-card apartments">
          ...
          <div class="my-card-body">
            ...
            <b>Total Available: </b><?php echo $totalavailable;?>
              ...
              <br />
              <b>Total Reserved: </b><?php echo $totalreserved;?>
              <?php //echo $row['State1']." ".$row['Postal_Code']." ".$row['Country']; ?>
            </h3>
            </a>
            <div class="mx-auto" style="width: 85%">
              ...
              <div class="d-flex align-items-stretch justify-content-between">
                <button class="btn btn-sm  fs-12" onclick="editproject('<?php echo $id; ?>')">
                  <span class="material-icons"> edit </span>
                  Edit
                </button>
                <div class="border border-end"></div>
                <div class="dropdown">
                  <button class="btn btn-sm fs-12" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                    aria-expanded="false">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li>
                      ...
                      <button onclick="activateproject('<?php echo $id; ?>')" class="dropdown-item">Publish</button>

                    </li>
                    <li>
                      <div class="dropdown-divider"></div>
                    </li>
                    <li><button onclick="disableproject('<?php echo $id; ?>')" class="dropdown-item">Archive</button>
                    </li>
                  </ul>
                </div>
                <div class="border border-end"></div>
