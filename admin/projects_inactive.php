...
?>
    ...
    <main id="projectsmain">
      ...
      <div class="content">
        ...
        >
          <div>
            <h1 class="mainUserText">Archived Projects</h1>
        ...
        <div class="row g-4">
          <?php
            $sql = "SELECT * FROM projects where status1 = 'inactive'";
                ...
                ?>
                  <div class="col-lg-4 col-md-6">
                    <div class="my-card apartments">
                      <img src="./assets/images/pictures/project-card-img.png" alt="" />
                          ...
                          >
                            ...
                            <div class="dropdown">
                              ...
                              >
                                ...
                                <li><button disabled onclick="disableproject('<?php echo $id; ?>')" class="dropdown-item">Archive</button></li>
                              </ul>
                            </div>
                            <div class="border border-end"></div>
