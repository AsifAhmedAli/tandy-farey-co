  ...
  <h1 class="mainUserText"><?php echo $Title; ?></h1>
    ...
    <div class="d-flex align-items-center justify-content-between flex-wrap">
      ...
      <div class="d-flex align-items-center mt-3">
                ...
                <div class="outer-container">
                  <form id="exceluploadform">
                    <div>
                      ...
                      <button type="submit" id="submit" class="btn-submit btn btn-primary">Import</button>

                    </div>
                    <input type="text" style="visibility: hidden;" value="<?php echo $id; ?>" name="mynaawe">
                  </form>
        ...
        <button class="btn btn-outline-primary"  data-bs-toggle="modal" data-bs-target="#archived">Archived</button>
      </div>
      </div>
    </div>
    <hr />
