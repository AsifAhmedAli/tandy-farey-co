  ...
  <div class="content">
    ...
    <div class="table-responsive">
      <table class="table" style="min-height: 300px;">
        ...
        <tbody class="fs-14">
<?php
$sql = "SELECT * FROM project_documents where file_type = 'Fixtures' and project_id = '$id'";
$result = $conn->query($sql);
$i = 0;
if ($result->num_rows > 0) {
  // output data of each row
    ...
    <div class="modal-content">
      <div class="modal-body">
 	      <form id="fileuploadform">
              ...
              <input type="text" style="visibility: hidden;" id="Fixtures" name="Fixtures" value="<?php echo $id; ?>">
...
<script>
  ...
  //   });
  // }
  function deleteimage(x19){
    var xaa = document.getElementById("Fixtures").value;
    // alert(x);
    document.getElementById("loader1").style.visibility = "visible";
    $.ajax({
        type: "post",
        data: {x19:x19,xaa:xaa},
        url: "controllers.php",
        success: function (result) {
            $("#div12").html(result);
            document.getElementById("loader1").style.visibility = "hidden";
