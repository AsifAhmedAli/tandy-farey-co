      ...
      ?>
          <div class="col-xxl-2 col-xl-3 col-lg-2 col-md-4 col-sm-3 col-6">
            <div class="matrix-item" type="button" style="background-color: <?php echo $selected_color; ?>;"
              ...
              <p class="status"><?php echo "$".number_format($row['price']); ?></p>
                ...
                <div class="modal-body px-0">
                  ...
                  <div class="tab-content" id="pills-tabContent<?php echo $i; ?>">
                    <div class="tab-pane fade show active" id="pills-home<?php echo $i; ?>" role="tabpanel"
                          ...
                          <tbody>
                            <tr>
                              <td>
                                ...
                                <h6 class="fs-18"><?php echo "$".number_format($row['price']); ?></h6>
                              </td>
                              <td>
                      ...
                      <hr>
                      <h2 class="text-center mt-3">Change Status of Property</h2>
                      <form class="col-6 my-3 mx-auto">
                      <select class="form-select" onchange="savestatus('<?php echo $idofproperty; ?>','dropdownproperty<?php echo $i; ?>','showDetails<?php echo $i; ?>')" id="dropdownproperty<?php echo $i ?>" aria-label="Default select example">
                        ...
                        if ($result55->num_rows > 0) {
                          ...
                          while($row55 = $result55->fetch_assoc()){
                            ...
                            <div class="col-12 my-2 text-center">
                              <img  data-enlargeable style="cursor: zoom-in"  src="<?php echo "../uploads/".$row55['document_name']; ?>" width="50%" alt="">
                            </div>
                            <hr>
                            <?php
                          }
...
<div class="modal fade" id="buyerdetailsmodel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <input type="text" class="form-control" id="buyername" placeholder="Buyer Name" aria-describedby="basic-addon1">
    </div>
    <div class="form-check">
      ...
      <input type="text" style="visibility: hidden;" id="idofproperty">
...
<script>
  function updatedata(){
    var idofproperty502 = document.getElementById("idofproperty").value;
    var buyername = document.getElementById("buyername").value;
    var advancepaid = document.getElementById("flexCheckDefault").checked;
    // alert(idofproperty + buyername + advancepaid);
    document.getElementById("loader1").style.visibility = "visible";
  // alert(x23);
  $.ajax({
      type: "post",
      data: {
        idofproperty502:idofproperty502,
        buyername:buyername,
...
function savestatus(x21, x22, x23){
  var dropdownselected = document.getElementById(x22).value;
  document.getElementById("loader1").style.visibility = "visible";
  // alert(x23);
  $.ajax({
      type: "post",
